...
class DTOSVICReversaleGETResult(BaseModel):
    """
    ...
    anno_accertamento: Optional[StrictInt] = Field(default=None, alias="AnnoAccertamento")
    numero_accertamento: Optional[StrictInt] = Field(default=None, alias="NumeroAccertamento")
    ...
    __properties: ClassVar[List[str]] = ["ANNO", "NUMERO", "DataOperazione", "CAUSALE", "CAPITOLO", "ARTICOLO", "IMPORTO", "AnnoAccertamento", "NumeroAccertamento", "CompetenzaResiduo", "DETTAGLIO", "CodiceErrore", "ERRORE"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "AnnoAccertamento": obj.get("AnnoAccertamento"),
