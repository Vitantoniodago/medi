...
class DTOAPIRichiestaInterventi(BaseModel):
    """
    ...
    data_riferimento: Optional[datetime] = Field(default=None, description="Richiedi o modifica data riferimento.", alias="DataRiferimento")
