...
class DTOModelloParziale(BaseModel):
    """
    ...
    settimana: Optional[List[StrictBool]] = Field(default=None, description="Richiedi o modifica settimana.", alias="Settimana")
    gg_settimana: Optional[StrictInt] = Field(default=None, alias="GGSettimana")
    __properties: ClassVar[List[str]] = ["TimeStart", "TimeEnd", "Settimana", "GGSettimana"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "Settimana": obj.get("Settimana"),
            "GGSettimana": obj.get("GGSettimana")
        })
        return _obj
