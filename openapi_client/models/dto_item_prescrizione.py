...
class DTOItemPrescrizione(BaseModel):
    """
    
    """ # noqa: E501
    id_item_prescrizione: Optional[StrictInt] = Field(default=None, description="Richiedi o modifica identifier item prescrizione.", alias="IDItemPrescrizione")
    ...
    __properties: ClassVar[List[str]] = ["IDItemPrescrizione", "IDPrescrizione", "TimeStart", "TimeEnd", "Lunedi", "Martedi", "Mercoledi", "Giovedi", "Venerdi", "Sabato", "Domenica"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "IDItemPrescrizione": obj.get("IDItemPrescrizione"),
