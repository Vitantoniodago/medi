...
class DTOSVICMandatoSpesaFissaPOST(BaseModel):
    """
    DTOSVICMandatoSpesaFissaPOST
    """ # noqa: E501
    capitolo: Optional[StrictStr] = Field(default=None, alias="Capitolo")
    articolo: Optional[StrictStr] = Field(default=None, alias="Articolo")
    ...
    __properties: ClassVar[List[str]] = ["Capitolo", "Articolo", "Causale", "AnnoPagamento", "AnnoCompetenza", "Dettaglio"]
