...
class TestDTOAPISomministrazioni(unittest.TestCase):
    """DTOAPISomministrazioni unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DTOAPISomministrazioni:
        """Test DTOAPISomministrazioni
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DTOAPISomministrazioni`
        """
        model = DTOAPISomministrazioni()
        if include_optional:
            return DTOAPISomministrazioni(
                somministrazione = [
    ...
    def testDTOAPISomministrazioni(self):
        """Test DTOAPISomministrazioni"""
