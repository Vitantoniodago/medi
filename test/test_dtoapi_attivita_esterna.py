...
class TestDTOAPIAttivitaEsterna(unittest.TestCase):
    """DTOAPIAttivitaEsterna unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DTOAPIAttivitaEsterna:
        """Test DTOAPIAttivitaEsterna
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DTOAPIAttivitaEsterna`
        """
        model = DTOAPIAttivitaEsterna()
        if include_optional:
            return DTOAPIAttivitaEsterna(
                id_ordine_lavoro = 56,
                codice = '',
                id_turno = 56,
    ...
    def testDTOAPIAttivitaEsterna(self):
        """Test DTOAPIAttivitaEsterna"""
