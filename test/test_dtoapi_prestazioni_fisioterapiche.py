...
class TestDTOAPIPrestazioniFisioterapiche(unittest.TestCase):
    """DTOAPIPrestazioniFisioterapiche unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DTOAPIPrestazioniFisioterapiche:
        """Test DTOAPIPrestazioniFisioterapiche
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DTOAPIPrestazioniFisioterapiche`
        """
        model = DTOAPIPrestazioniFisioterapiche()
        if include_optional:
            return DTOAPIPrestazioniFisioterapiche(
    ...
    def testDTOAPIPrestazioniFisioterapiche(self):
        """Test DTOAPIPrestazioniFisioterapiche"""
