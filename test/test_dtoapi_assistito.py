...
class TestDTOAPIAssistito(unittest.TestCase):
    """DTOAPIAssistito unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DTOAPIAssistito:
        """Test DTOAPIAssistito
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DTOAPIAssistito`
        """
        model = DTOAPIAssistito()
        if include_optional:
            return DTOAPIAssistito(
                guid_assistito = '',
                id_assistito = 56,
                nome = '',
                cognome = '',
