...
class TestDTOAPIPrescrizioni(unittest.TestCase):
    """DTOAPIPrescrizioni unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DTOAPIPrescrizioni:
        """Test DTOAPIPrescrizioni
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DTOAPIPrescrizioni`
        """
        model = DTOAPIPrescrizioni()
        if include_optional:
            return DTOAPIPrescrizioni(
                prescrizione = [
    ...
    def testDTOAPIPrescrizioni(self):
        """Test DTOAPIPrescrizioni"""
